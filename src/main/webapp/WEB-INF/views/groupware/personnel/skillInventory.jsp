		  ...
		  <legend>인사카드</legend>
			...
			<div class="section form2">
			  ...
			  <p class="form-floating">
				...
				<span class="txt">2005년 1월 ~ 2021년 12월 (7년 11개월)</span>
			  </p>
			  ...
			  <div class="table">
				<div class="table-header d-flex justify-content-between align-items-center">
				  <div class="left">
					...
					<button class="btn print" type="button" data-bs-toggle="modal" data-bs-target="#careerPrintModal">경력사항출력</button>
					<button class="btn print" data-bs-toggle="modal" data-bs-target="#skillPrintModal" type="button">스킬인벤토리출력</button>
				  </div>
				  <div class="right">
					<button id="exskillAddBtn" class="btn add" type="button" onclick="clearInputs();$('#skillModal_external').modal('show')"><i class="ri-add-line"></i> 신규직원 추가작성</button>
					<button id="inskillAddBtn" class="btn add" type="button" onclick="openInternalSkillModal();"><i class="ri-add-line"></i> 테라에너지 스킬 추가작성</button>
					<button class="btn add" type="button"><i class="ri-add-line"></i> 엑셀업로드</button>
				  </div>
				</div>
				...
				<div class="table-footer">
				  <div class="right">
					<button class="btn" type="button"><i class="ri-download-fill"></i> 양식다운로드</button>
				  </div>
				</div>
			  </div>
...
var appendSkillTableData=function(){
	...
	.done(function(data){
		...
		if(data && data.success){ // data 라는 객체가 null이 아니고, data.success 가 true이면
