	...
	<div class="panel panel-default justify-content-between">
		<div class="panel-body">
					...
					<div class="tab-btns modal">
						<ul>
							...
							<li><label class="checkbox-inline"><input
									class="filter common" type="radio" name="type_check" value="공통" />공통</label>
							</li>
							<li><label class="checkbox-inline"><input
			...
			<div class="insert_calender">
				<a class="btn schedule-btn" data-bs-toggle="modal" role="button">일정
					등록</a>
			</div>
		</div>
	</div>
					...
					<form class="schedule-form">
						...
						<ul class="schedule-form-ul">
							...
							<li><span class="th">색상</span>
								<div class="td">
									<input type="radio" id="c-red" value="#D25565"
										name="edit-color"><label style="color: #D25565;"
										for="c-red">빨강색</label> <input type="radio" id="c-purple"
										value="#9775fa" name="edit-color"><label
										style="color: #9775fa;" for="c-red">보라색</label> <input
										type="radio" id="c-blue" value="#74c0fc" name="edit-color"><label
										style="color: #74c0fc;" for="c-blue">파란색</label> <input
										type="radio" id="c-pink" value="#f06595" name="edit-color"><label
										style="color: #f06595;" for="c-pink">핑크색</label> <input
										type="radio" id="c-green" value="#a9e34b" name="edit-color"><label
										style="color: #a9e34b;" for="c-green">초록색</label> <input
										type="radio" id="c-black" value="#495057" name="edit-color"><label
