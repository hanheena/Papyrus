						...
						<div>
							<div>
								...
								<div id="line_user_list_append">
									<c:forEach var="e" items="${elctApprovLineList}" varStatus="s">
										<div id="elect_line_user_div_${e.userId}"class="elect_line_user_div">
										${e.krName} ${e.codeName} ${s.count}</div>
									</c:forEach>
								</div>
								<hr />
							</div>
							...
							<div class="content">
									...
									<table class="table border-top separate">
										...
										<tbody>
											<tr>
												...
												<td><input disabled="disabled" class="w120" type="text"readonly value="${userInfo.krName}"></td>
												<th scope="row"><label for="">신청ID</label></th>
												<td><input disabled="disabled" type="text" readonly value="${dayOff.userId}"></td>
											</tr>
										</tbody>
									</table>
								</div>
								...
								<div class="content-write mb10">
									<table>
										...
										<tbody>
											<tr>
												<input name="id" class="id" id="id" type="hidden" readonly value="${dayOff.id}" />
											...
											<tr>
												...
												<td colspan="4"><input name="dayOffStt" tabindex="8"class="dayOffStt" id="dayOffStt" type="date"value="${dayOff.dayOffStt}" readonly>~ 
												<input name="dayOffEnd" tabindex="9" class="dayOffEnd"id="dayOffEnd" type="date" value="${dayOff.dayOffEnd}"readonly> 
												( 일수 : <input name="dayOffUseCnt"class="dayOffUseCnt" id="dayOffUseCnt" type="text" value="${dayOff.dayOffUseCnt}" readonly> )
												<td>
											...
											<tr>
												...
												<td colspan="5"><textarea rows="2" id="dayOffReason"name="dayOffReason" cols="100" name="dayOffReason">${dayOff.dayOffReason}</textarea><!-- 휴가사유 --></td>
											</tr>
											<tr>
												<th scope="row"><label for="dayOffReason">*결재상태</label></th>
												<td colspan="5"><input type="text" name="EAppvStat"tabindex="5" class="EAppvStat" id="EAppvStat"value="${dayOff.EAppvStat}" readonly><!--결재상태 --></td>
											</tr>
								...
								<div class="overflowH">
									...
									<div class="btn-wrap fright" style="float: left; margin: 2px;">
										<a a href="#" onclick="history.back();"><input type="button"class="btn3" id="btn3" value="뒤로"></a>
									</div>
								</div>
							</div>
						</div>
...
<!-- 개별 페이지 스크립트 -->
<script type="text/javascript" src="/resources/js/groupware/vacation/dayOffDetail.js"></script>
<script>
$(function () {
