      ...
      <div class="row gx-2">
        ...
        <div class="col-2">
          <div class="inner">
            ...
            <ul class="btn-list">
              <li><button class="btn" onclick="userRegister()">인사카드생성</button></li>
              <li class="reg-send-btn">
                <button class="btn">가입인증전송</button>
                <!-- 가입인증전송 팝업 -->
                <div class="reg-send modal">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title">가입인증전송</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                      <form>
                        <p class="form-floating"><label class="th" for="regName">이름</label> <input type="email" id="regName" class="form-control" /></p>
                        <p class="form-floating"><label class="th" for="phoneNum">휴대폰번호</label> <input type="tel" id="phoneNum" class="form-control" /></p>
                      </form>
                    </div>
